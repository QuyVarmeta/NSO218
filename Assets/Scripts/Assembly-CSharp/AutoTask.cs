...
public class AutoTask : Auto
{
	...
	public void Pick(int npcId, bool menu = false, bool getTask = false, int between = 0, int last = 0)
	{
		...
		if (npc != null)
		{
			...
			if (menu)
			{
				Service.gI().menu(0,npcId, between, last);
			}
			if (getTask)
			{
