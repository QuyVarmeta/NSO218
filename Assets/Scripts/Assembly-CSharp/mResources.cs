public class mResources
{
	...
	public static int Lang_VI;

	public static int Lang_EN = 1;

	public static int Lang_CAM = 2;
	...
	public static string INPUT_ACC_FORGET;

	public static string ASK_ACC_CHANGE;
	...
	public static string ASK_ACC_FORGET;
	...
	public static string[] LANGUAGES2;
	...
	public static string ANALOG_KEY;
	...
	public static string[] HELPSPLIT;
	...
	public static string GOLD_LOCK_BUY;

	public static string GOLD;

	public static string NO_CLAN;

	public static string CANNOTUP;
	...
	public static string ERRONUMBER;
	...
	public static string[] LOGINLABELS;
	...
	public static string[] CLANLEADER_SELECT;
	...
	public static string[] HELPPOTENTIAL4;
	...
	public static string INPUT_PRIVATE_REPASS;
	...
	public static string INFO_SEND_SMS_RE;

	public static string INFO_SEND_SMS_FOGETPASS;

	public static string NOT_INPUT_PASS;

	public static string control1 = string.Empty;

	public static string control2 = string.Empty;
	...
	public static void loadLanguage(int languageID)
	{
		mResources.languageID = languageID;
		LanguageScr.saveLanguageID(mResources.languageID);
		if (languageID == Lang_VI)
		{
			...
			tips = new string[2][]
			{
				new string[14]
				{
					"Bạn có thể nhấn giữ nút chuyển mục tiêu để hiển thị danh sách người chơi khác trong map", "Bạn có thể sử dụng cách điều khiển bằng Phím cảm ứng hoặc Analog", "Cừu sát sẽ làm tăng 2 điểm hiếu chiến. Đồ sát sẽ làm tăng 1 điểm hiếu chiến", "Đối với Kiếm, Kunai, Đao: Nên tăng Sức Mạnh, Thể Lực, Thân pháp", "Đối với Cung, Phi Tiêu, Quạt: Nên tăng Chakra, Thể Lực, Thân pháp", "Lập tổ đội đi luyện cùng nhau bạn sẽ nhận được nhiều kinh nghiệm hơn và làm nhiệm vụ nhanh hơn", "Để giảm hiếu chiến, bạn phải bị người khác đánh trọng thương. Vào đấu trường để thi đấu để giảm", "Khi tách đá khỏi trang bị, bạn sẽ thu lại một nửa số đá ép vào lúc đầu", "Bạn có thể đổi Xu từ Yên, với điều kiện có đủ điểm hoạt động", "Bạn sẽ có phần thưởng nếu đạt thành tích cao nhất trong đấu trường mỗi ngày",
					"Để vào khu vực đấu trường, hãy tìm Rikudou đứng ở mỗi trường", "Bạn có thể tăng tỉ lệ thành công khi nâng cấp đồ bằng cách chọn phương pháp Cẩn Thận, nhưng sẽ tốn Lượng", "Bạn được tặng 10 lượng khi đạt cấp độ 20 tại NPC Okanechan", "Tiền Lượng được chia sẻ cho 3 nhân vật trong 1 tài khoản"
				},
				new string[18]
				{
					"Dùng các phím Q,W,E,A,D: Di chuyển nhân vật", "Hoặc các phím Lên,Trái,Phải: Di chuyển nhân vật", "Phím Spacebar hoặc phím Enter: Tấn công hoặc hành động", "Phím F1: Menu,Phím F2: Đổi mục tiêu,Phím 6, 7: Dùng bình HP,MP", "Phím 0: Chat,Phím P: Đổi kỹ năng,Phím 1,2,3,4,5: Sử dụng kỹ năng được gán trước trong mục Kỹ Năng", "Cừu sát sẽ làm tăng 2 điểm hiếu chiến.", " Đồ sát sẽ làm tăng 1 điểm hiếu chiến", "Đối với Kiếm, Kunai, Đao: Nên tăng Sức Mạnh, Thể Lực, Thân pháp", "Đối với Cung, Phi Tiêu, Quạt: Nên tăng Chakra, Thể Lực, Thân pháp", "Lập tổ đội đi luyện cùng nhau bạn sẽ nhận được nhiều kinh nghiệm hơn và làm nhiệm vụ nhanh hơn",
					"Để giảm hiếu chiến, bạn phải bị người khác đánh trọng thương. Vào đấu trường để thi đấu để giảm", "Khi tách đá khỏi trang bị, bạn sẽ thu lại một nửa số đá ép vào lúc đầu", "Bạn có thể đổi Xu từ Yên, với điều kiện có đủ điểm hoạt động", "Bạn sẽ có phần thưởng nếu đạt thành tích cao nhất trong đấu trường mỗi ngày", "Để vào khu vực đấu trường, hãy tìm Rikudou đứng ở mỗi trường", "Bạn có thể tăng tỉ lệ thành công khi nâng cấp đồ bằng cách chọn phương pháp Cẩn Thận, nhưng sẽ tốn Lượng", "Bạn được tặng 10 lượng khi đạt cấp độ 20 tại NPC Okanechan", "Tiền Lượng được chia sẻ cho 3 nhân vật trong 1 tài khoản"
				}
			};
			...
			TERM = "Quy định";
			SEND_TO = "\n gửi tới ";
			INFO_SEND_SMS_RE = "Để đăng ký tài khoản vui lòng soạn: \n";
			INFO_SEND_SMS_FOGETPASS = "Để lấy lại mật khẩu vui lòng soạn: \n";
			SOUND = "Âm thanh ";
			SCREEN1 = "Màn hình nhỏ";
			SCREEN2 = "Màn hình lớn";
			CAUHINHTHAP = "Cấu hình thấp";
			CAUHINHCAO = "Cấu hình cao";
			PLEASEWAIT = "Xin chờ";
			WAIT = "Chờ";
			MENU = "Menu";
			NEED = "Cần";
			...
			LANGUAGE = "Khu Vực";
			RMS = "Xóa bộ nhớ tạm";
			LANGUAGES = new string[2] { "Việt Nam", "Global" };
			LANGUAGES2 = new string[2] { "ភ\u17b6ស\u17b6ខ\u17d2ម\u17c2រ", "ភ\u17b6ស\u17b6អង\u17cbគ\u17d2ល\u17c1ស" };
			...
			REGISTER_TEXT = new string[2] { "Để xác thực với tên", "bạn phải đồng ý với quy định của trò chơi." };
			...
			CLANPT_MESSAGE = new string[3] { "Tin nhắn gia tộc, nhóm", "Tin nhắn gia tộc", "Tin nhắn nhóm" };
			PROTECT = "hộ tống";
			UPPOINT = "Cộng";
			UPPOINTS = "Cộng nhiều";
			...
			Level = "Cấp";
			level = "cấp";
			control1 = "Cách điều khiển 1";
			control2 = "Cách điều khiển 2";
			...
			UPGRADE_CONDITION = new string[3] { "Chỉ được chuyển hóa trang bị cùng", "loại và cùng cấp trở lên.", "Sẽ khóa trang bị sau khi chuyển hóa." };
			...
			CELL = "ô";
			CELLS = "ô thứ";
			KEY_QWERTY = new string[3] { "Phím Q", "Phím W", "Phím E" };
			KEY_T9 = new string[3] { "Phím 7", "Phím 8", "Phím 9" };
			HAIR_STYLE = new string[2][]
			{
				new string[4] { "ngắn", "cài trâm", "búi", "xù" },
				new string[4] { "đeo băng", "bó xù", "samurai", "nhím" }
			};
			MENUME = new string[7] { "Hành trang", "Kỹ năng", "Tiềm năng", "Thông tin", "Trang bị", "Thú Cưỡi", "Vĩ Thú" };
			TITLECLOTHE = new string[2] { "Tiệm Y Phục", "Hành trang" };
			TITLENON = new string[2] { "Nón", "Hành trang" };
			TITLEAO = new string[2] { "Áo", "Hành trang" };
			TITLEGANGTAY = new string[2] { "Găng tay", "Hành trang" };
			TITLEQUAN = new string[2] { "Quần", "Hành trang" };
			TITLEGIAY = new string[2] { "Giày", "Hành trang" };
			TITLEDAYCHUYEN = new string[2] { "Dây chuyền", "Hành trang" };
			TITLENHAN = new string[2] { "Nhẫn", "Hành trang" };
			TITLENGOCBOI = new string[2] { "Ngọc bội", "Hành trang" };
			TITLEPHU = new string[2] { "Bùa", "Hành trang" };
			TITLEWEAPON = new string[2] { "Binh khí", "Hành trang" };
			TITLESTACK = new string[2] { "Dược phẩm", "Hành trang" };
			TITLESTACKLOCK = new string[2] { "Dược phẩm", "Hành trang" };
			TITLEGROCERY = new string[2] { "Thức ăn", "Hành trang" };
			TITLEGROCERYLOCK = new string[2] { "Thức ăn", "Hành trang" };
			TITLEUPGRADE = new string[2] { "Nâng cấp", "Hành trang" };
			TITLESTAND = new string[2] { "Gian hàng", "Hành trang" };
			TITLECONVERT = new string[2] { "Chuyển hóa", "Hành trang" };
			TITLEUPPEARL = new string[2] { "Luyện đá", "Hành trang" };
			TITLEBOX = new string[2] { "Rương đồ", "Hành trang" };
			TITLESTORE = new string[4] { "Cửa hàng", "Quầy sách", "Thời trang", "Gia Tộc" };
			TITLEELITESHOP = new string[1] { "Bảo vật" };
			TITLECLANSTORE = new string[1] { "Cửa hàng gia tộc" };
			TITLESPLIT = new string[2] { "Tách Đá", "Hành trang" };
			TITLETRADE = new string[2] { "Giao dịch", "Hành trang" };
			TITLELUYENTHACH = new string[2] { "Luyện thạch", "Hành trang" };
			TITLELUYENTHU = new string[2] { "Dịch chuyển", "Hành trang" };
			TITLELUYENAO = new string[2] { "Tinh luyện", "Hành trang" };
			TITLEKHAMNGOC = new string[2] { "Khảm ngọc", "Hành trang" };
			TITLELUYENNGOC = new string[2] { "Luyện ngọc", "Hành trang" };
			TITLEGOTNGOC = new string[2] { "Gọt ngọc", "Hành trang" };
			TITLEGIAODO = new string[2] { "Giao đồ", "Hành trang" };
			TITLETHAONGOC = new string[2] { "Tháo ngọc", "Hành trang" };
			...
			HELPCRYSTAL = new string[3] { "- Sử dụng Yên, nếu không đủ dùng Xu", "- Qua trang Hành Trang để chọn Đá", "- Số lượng đá từ 2 đến 24" };
			HELPUPGRADE = new string[4] { "- Sử dụng Yên, nếu không đủ dùng Xu", "- Nâng cấp cẩn thận cần dùng lượng", "- Chỉ chọn Trang Bị và Đá", "Trang bị đã được nâng cấp tối đa" };
			HELPSPLIT = new string[3] { "- Qua Hành Trang để chọn Trang Bị", " Sau khi tách xong sẽ như lúc đầu", "Trang bị đã được tách" };
			HELPKHAMNGOC = new string[2] { "- Sử dụng Yên, nếu không đủ dùng Xu", "- Chỉ chọn Trang Bị và Ngọc" };
			LOCK1 = "Khóa G.Dịch";
			...
			CLASSNEED = "Lớp: ";
			TASK = new string[2] { "Chính tuyến", "Phụ tuyến" };
			ME_TASK = "Nhiệm vụ";
			...
			FRIENDS = new string[2] { "Bạn bè", "Thù Địch" };
			...
			YOU_AND = "Bạn và";
			MENUGAMESCR = new string[19]
			{
				"Cửa hàng", "Bản thân", "Bản đồ", "Tổng hợp", "Thoát", "Trang sức", "Tính năng", "Dược khóa", "Dược phẩm", "Tạp hóa khóa",
				"Tạp hóa", "Cường hóa", "Luyện hóa", "Luyện hóa khóa", "Thủ khố", "Tách trang bị", "Khu vực", "Giao dịch", "Tin nhắn"
			};
			SKILLTYPE = new string[5] { "Hỗ trợ bị động", "Chủ động sử dụng", "Chủ động sử dụng", "Chủ động sử dụng", "Chủ động sử dụng" };
			NOPOINT = new string[2] { "Bạn đã hết điểm kỹ năng. Vui lòng đánh lên level để có thêm điểm kỹ năng", "Bạn đã hết điểm tiềm năng. Vui lòng đánh lên level để có thêm điểm tiềm năng" };
			inforMe = new string[20]
			{
				"Nhân vật: ",
				"Hiếu chiến: ",
				"Trình độ: ",
			...
			NUMBER = " lần";
			TITLE_CT = new string[5] { "Học Giả", "Hạ nhẫn", "Trung Nhẫn", "Thượng Nhẫn", "Nhẫn Giả" };
			inforMePoint = new string[20]
			{
				"Điểm hoạt động: ", "Danh vọng vũ khí: ", "Danh vọng dây chuyền: ", "Danh vọng nhẫn: ", "Danh vọng ngọc bội: ", "Danh vọng bùa: ", "Danh vọng nón: ", "Danh vọng áo: ", "Danh vọng găng tay: ", "Danh vọng quần: ",
				"Danh vọng giày: ", "Hoàn thành NV mỗi ngày: ", "Truy bắt Tà Thú còn: ", "Học sách tiềm năng sơ: ", "Học sách kỹ năng sơ: ", "Gia tộc: ", "Vào hang động còn: ", "Điểm tinh tú: ", "Số lần ăn bánh phong lôi: ", "Số lần ăn bánh băng hỏa: "
			};
			ERRONUMBER = "Có lỗi xảy ra. Xin vui lòng chỉ nhập số";
			MENUNEWCHAR = new string[3] { "Tên: ", "Giới tính: ", "Tóc: " };
			MENUGENDER = new string[2] { "Nữ", "Nam" };
			NAMEEXIST = "Tên nhân vật đã có. Vui lòng chọn tên khác";
			NAMEFALSE = "Tên nhân vật không đúng. Chỉ bao gồm các ký tự từ chữ và số";
			NAMEPOTENTIAL = new string[4] { "Sức mạnh", "Thân pháp", "Thể lực", "Chakra" };
			NAMEPOTENTIAL2 = new string[4] { "Sức mạnh", "Nhanh nhẹn", "Sức khỏe", "Trí tuệ" };
			...
			ITEMNAME = new string[28][]
			{
				new string[1] { "nón" },
				new string[2] { "vũ", "khí" },
				new string[1] { "áo" },
				new string[2] { "vòng", "cổ" },
				new string[2] { "găng", "tay" },
				new string[1] { "nhẫn" },
				new string[1] { "quần" },
				new string[1] { "bội" },
				new string[1] { "giày" },
				new string[1] { "bùa" },
				new string[2] { "thú", "nuôi" },
				new string[2] { "mặt", "nạ" },
				new string[2] { "ninja", "yoroi" },
				new string[2] { "gia", "tộc" },
				new string[2] { "chưa", "mở" },
				new string[2] { "bí", "kíp" },
				new string[2] { "áo", "giáp" },
				new string[2]
				{
					"yên",
					string.Empty
				...
				new string[2] { "trang", "sức" },
				new string[2] { "động", "cơ" },
				new string[2] { "định", "vị" },
				new string[2] { "bộ", "đk" },
				new string[2] { "bình", "nitro" },
				new string[2] { "móng", "vuốt" },
				new string[2] { "dây", "chuyền" },
				new string[2] { "thú", "bảo" },
				new string[2]
				{
					"xích",
					string.Empty
			...
			SYS = new string[4] { "Chưa vào trường", "Trường: Hirosaki", "Trường: Ookaza", "Trường: Haruna" };
			SYSITEM = new string[4]
			{
				string.Empty,
				"Thuộc tính: Hỏa",
				"Thuộc tính: Thủy",
			...
			TYPEUPPEARL = new string[2] { "Luyện đá thành công", "Luyện đá thất bại" };
			TYPEUPGRADE = new string[4] { "Thành công, trang bị được lên cấp ", "Thất bại, trang bị trở về cấp ", "Trang bị được nâng cấp tối đa", "Trang bị cấp" };
			TYPEKHAMNGOC = new string[2] { "Khảm ngọc thành công", "Khảm ngọc thất bại" };
			MONTH = "tháng";
			WEEK = "tuần";
			DAY = "ngày";
			HOUR = "giờ";
			...
			GENDER = new string[2] { "Giới tính: nữ", "Giới tính: nam" };
			ZONE = "Khu vực";
			POPULATION = "Dân số";
			PARTY = "Nhóm";
			NOT_IN_PARTY = "Hiện tại bạn không vào nhóm nào";
			COUNT = "lần";
			CLAN = new string[5] { "Thông tin", "Thành viên", "Nhà Kho", "Thống Kê", "Thần Thú" };
			CLANINFO = new string[13]
			{
				"Gia tộc: ", "Tộc trưởng: ", "Thành viên: ", "Cấp: ", "Kinh nghiệm: ", "Ngân sách: ", "Thành lập: ", "Cống hiến: ", "Phí duy trì: ", "Phí nâng cấp: ",
				"Vào Lãnh Địa Gia Tộc: còn ", "Cống hiến tuần: ", "Sử dụng lệnh bài còn: "
			};
			CLAN_ACTIVITY = new string[7] { "xu lúc", "Thành lập gia tộc, ngân sách nhận", "bị trục xuất, ngân sách trừ", "đóng góp quỹ gia tộc, ngân sách tăng", "rút quỹ gia tộc, ngân sách giảm", "Thu phí duy trì gia tộc, ngân sách giảm", "nâng cấp gia tộc, ngân sách giảm" };
			NOT_IN_CLAN = "Hiện tại bạn chưa gia nhập gia tộc";
			CLAN_BOX = "Phát cho Thành viên";
			TELEPORT = new string[5][]
			{
				new string[1] { "Trường Hirosaki" },
				new string[1] { "Trường Haruna" },
				new string[1] { "Trường Ookaza" },
				new string[8] { "Làng", "Làng Kojin", "Làng Sanzu", "Làng Tone", "Làng chài", "Làng Chakumi", "Làng Echigo", "Làng Oshin" },
				new string[1] { "Khu vực" }
			};
			BODY = new string[10] { "Nón", "Nhân", "Áo", "Dây chuyền", "Găng tay", "Nhẫn", "Quần", "Ngọc bội", "Giày", "Bùa" };
			LINE = new string[2] { "Kích ẩn", "Kích cấp độ" };
			KICKSYS = new string[4]
			{
				string.Empty,
				"Hỏa",
				"Thủy",
			...
			CHARINGFO = new string[3]
			{
				"Nhân vật",
				"Level",
				string.Empty
			};
			LOGINLABELS = new string[2] { "Chưa có tài khoản xin", "chọn menu đăng ký." };
			...
			CHAR_ORDER = new string[12]
			{
				"Giao dịch", "Tỷ thí", "Cừu sát", "Kết bạn", "Mời vào nhóm", "Phục hồi", "Xem thông tin", "Chat riêng", "Mời vào tộc", "Xin vào tộc",
				"Chặn xin vào tộc", "Tự Hồi Sinh"
			};
			ZONE_HERE = "Bạn đang ở khu vực này";
			DES_TASK = new string[4] { "Hãy đi tìm ", " ở ", " để nhận nhiệm vụ.", "Bạn đã hoàn thành hết nhiệm vụ phiên bản này, vui lòng chờ cho đến khi ra phiên bản tiếp theo." };
			DIES = new string[4] { "Kiệt sức", "Đứng nhìn", "Quay về", "Hồi sinh tại chỗ (1 lượng)" };
			...
			PKS = new string[4] { "PK Thường", "PK Phe", "PK Bang", "PK Đồ Sát" };
			ACTIONS = new string[8] { "Trạng thái PK", "Bạn bè", "Thù Địch", "Nhóm", "Tìm nhóm", "Gia tộc", "Bảo vệ tài khoản", "Tự động" };
			SYNTHESIS = new string[3] { "Bản đồ", "Nhiệm vụ", "Gia tộc" };
			CLANS = new string[5] { "Tộc trưởng", "Tộc phó", "Trưởng lão", "Ưu tú", "Thành viên" };
			CLANS_STANDFOR = new string[4] { "(TT)", "(TP)", "(TL)", "(UT)" };
			CLAN_MENU = new string[9] { "Chỉ hiện Online", "Rời khỏi", "Thông báo", "Đóng góp", "Rút quỹ", "Nâng Cấp", "Mời vào lãnh địa", "Mời vào Gia tộc chiến", "Khai mở" };
			CLAN_SORTTYPE = "SX theo C.Hiến tuần";
			TEAMLEADER_SELECT = new string[3] { "Trục xuất", "Nhường", "Kết bạn" };
			CLANLEADER_SELECT = new string[2] { "Tộc phó", "Trưởng lão" };
			...
			HELPPOTENTIAL1 = new string[1] { "Bạn phải vào trường để tăng điểm" };
			HELPPOTENTIAL2 = new string[4] { "Sức mạnh = Tấn công", "Thân pháp = né,chính xác", "Thể lực = HP", "Chakra = MP" };
			HELPPOTENTIAL3 = new string[4] { "Không cần tăng sức mạnh", "Thân pháp = né,chính xác", "Thể lực = HP", "Chakra = Tấn công, MP" };
			HELPPOTENTIAL4 = new string[4] { "Sức mạnh = 10 tấn công", "Nhanh nhẹn = 10 chính xác", "Sức khỏe = 10s triệu hồi", "Trí tuệ = 1 MP" };
			CLOSE_CURTAB = "Đóng tab hiện tại";
			PUBLICCHAT = new string[2] { "Công cộng", "Bạn có thể chat với người đứng gần tại đây" };
			PARTYCHAT = new string[2] { "Chung nhóm", "Bạn có thể chat với người trong cùng nhóm tại đây" };
			GLOBALCHAT = new string[4] { "Kênh thế giới", "Bạn mất 5 lượng mỗi lần chat kênh thế giới.", "Tất cả người đang online đều thấy bạn chat.", "Bạn sẽ bị khóa tài khoản nếu chửi bậy, quảng cáo wap web trên kênh thế giới." };
			CLANCHAT = new string[2] { "Gia tộc", "Bạn có thể chat với người trong gia tộc tại đây" };
			...
			ASSIGN_KEY = new string[2] { "Gán phím tắt", "Gán vào 5 ô đánh" };
			...
			NEAR = "gần";
			DEADLINE = "hết giờ";
			MENUSTANDS = new string[12]
			{
				"Đá", "Nón", "Vũ khí", "Áo", "Dây chuyền", "Găng tay", "Nhẫn", "Quần", "Ngọc bội", "Giày",
				"Bùa", "Linh tinh"
			};
			...
			CLAN_ITEM = new string[5][]
			{
				new string[2] { "Yêu cầu: gia tộc đạt cấp 5.", "Phí khai mở: 1.000.000 xu gia tộc." },
				new string[2] { "Yêu cầu: gia tộc đạt cấp 10.", "Phí khai mở: 5.000.000 xu gia tộc." },
				new string[2] { "Yêu cầu: gia tộc đạt cấp 15.", "Phí khai mở: 10.000.000 xu gia tộc." },
				new string[2] { "Yêu cầu: gia tộc đạt cấp 20.", "Phí khai mở: 20.000.000 xu gia tộc." },
				new string[2] { "Yêu cầu: gia tộc đạt cấp 25.", "Phí khai mở: 30.000.000 xu gia tộc." }
			};
			AUTO_TEXT = new string[8] { "Dùng HP khi còn dưới: ", "Dùng MP khi còn dưới:", "Dùng thức ăn cấp: ", "Dùng chiêu hổ trợ", "Nhặt yên", "Nhặt Yên và HP,MP", "Nhặt Yên, HP, MP và N.Liệu", "Không nhặt gì cả" };
			...
			ALEVEL = new string[8] { "Cấp 1", "Cấp 10", "Cấp 20", "Cấp 30", "Cấp 40", "Cấp 50", "Cấp 60", "Cấp 70" };
			...
			LUYEN_THACH = new string[3] { "Luyện thạch cấp cao hơn bằng cách", "dùng 9 thạch cùng loại hoặc 3 thạch sơ", "và đá 11 hoặc 3 thạch trung và đá 12." };
			...
			CAT_KEO = "Cất kẹo";
			LEVEL_TINHLUYEN = "Tinh luyện cấp";
			MACHINE = "Động cơ";
			POWER = "Nhiên liệu";
			CHO_KEO = "Cho kẹo";
			...
			POWER = "Nhiên liệu";
			CHO_KEO = "Cho kẹo";
			TUTINH = new string[4] { "tử tinh", "tử tinh thạch sơ", "tử tinh thạch trung", "tử tinh thạch cao" };
		...
		else
		{
			...
			tips = new string[2][]
			{
				new string[14]
				{
					"Press change focus button to show all players on map", "For keyboard phones, assign shortcut keys 7,8,9 (or Q,W,E) to use skills.", "Berserk mode adds +2 agressive points.  Kill adds +1 agressive", "Sword, Kunai,and Blade increases Strength, Constitution, Dexterity", "Bow, Shuriken and Fan increases Chakra, Constitution, Dexterity", "Training as a team will earn experience and complete tasks faster", "Fighing other players on the battlefield will decrease combative points.", "When separated from the stone equipped, you will collect half amount of stone at the beginning.", "If you have enough action points, you can exchange coins from kin.", "The highest daily achievement in the arena will earn a reward.",
					"Find Rikudou to get into the arena.", "Precautionary measures cost money but will Increase the success rate of upgrading items", "When you reach Level 20, find Okanechan to received 10 gold bars.", "Gold bars will be split to 3 characters in 1 account"
				},
				new string[17]
				{
					"Use the key Q , W, E, A, D to move character", "Or you can use key Up, Left, Right to move char", "Key Spacerbar or Enter for attack or actions", "Key F1 : Menu, key F2: change focus, key 6,7 use HP,MP ", "key 0: Chat,key P: Change other skills, Key 1,2,3,4,5: use for skill  which is assigned in the skill's menu", "Berserket mode will increase 2 points of agressive. Kill just increase 1 point of agressive", "With Sword, Kunai, Blade: Should increase Strength, Constitution, Dexterity", "With Bow, Shuriken, Fan: Should increase Chakra, Constitution, Dexterity", "Make a team to train together, you will get more experienced and faster task", "To decrease combative point, you have to be fought by other players on the battlefield.",
					"When separated from the stone equipped, you will collect half amount of stone at the beginning.", "You can change the coins from kin incase you have enough action point.", "You will have a reward if you reach the highest achievement in the fight arena this day", "To get into the fight arena, look Rikudou stand in each school to check in to.", "You can increase the success rate when upgrading items by selecting a precautionary measure, but would cost amoun", "You will have 10 gold bars when you reach level 20, come to see NPC Okanechan", "Gold bars will be split to 3 characters in 1 account"
				}
			};
			...
			TERM = "Term";
			SEND_TO = "\n gửi tới ";
			INFO_SEND_SMS_RE = "To register please compose: \n";
			INFO_SEND_SMS_FOGETPASS = "For retreiving your account password, please compose: \n";
			SOUND = "Sound ";
			SCREEN1 = "Small screen";
			SCREEN2 = "Big screen";
			CAUHINHTHAP = "Cấu hình thấp";
			CAUHINHCAO = "Cấu hình cao";
			...
			REGISTER_TEXT = new string[2] { "To register with name", "you have to follow the game rule." };
			...
			CLANPT_MESSAGE = new string[3] { "message clan, group", "clan messages", "group message" };
			PROTECT = "escort";
			UPPOINT = "Plus";
			UPPOINTS = "Plus more";
			...
			UPGRADE_CONDITION = new string[3] { "Just transfer same type equipment", " or higher.", "Will lock fitted after transformation.." };
			...
			CELL = "Cell";
			CELLS = "Cells";
			KEY_QWERTY = new string[3] { "Key Q", "Key W", "Key E" };
			KEY_T9 = new string[3] { "Key 7", "Key 8", "Key 9" };
			HAIR_STYLE = new string[2][]
			{
				new string[4] { "tomboy", "with brooch", "pony tail", "curly" },
				new string[4] { "head band", "afro", "samurai", "spike" }
			};
			MENUME = new string[7] { "Inventory", "Skill", "Potential", "Info", "Equipment", "Mounts", "Bijuu" };
			TITLECLOTHE = new string[2] { "Costume shop", "Inventory" };
			TITLENON = new string[2] { "Cap", "Inventory" };
			TITLEAO = new string[2] { "Cloth", "Inventory" };
			TITLEGANGTAY = new string[2] { "Gloves", "Inventory" };
			TITLEQUAN = new string[2] { "Pants", "Inventory" };
			TITLEGIAY = new string[2] { "Shoes", "Inventory" };
			TITLEDAYCHUYEN = new string[2] { "Necklace", "Inventory" };
			TITLENHAN = new string[2] { "Ring", "Inventory" };
			TITLENGOCBOI = new string[2] { "Gems", "Inventory" };
			TITLEPHU = new string[2] { "Charms", "Inventory" };
			TITLEWEAPON = new string[2] { "Weapons", "Inventory" };
			TITLESTACK = new string[2] { "Medicine", "Inventory" };
			TITLESTACKLOCK = new string[2] { "Medicine", "Inventory" };
			TITLEGROCERY = new string[2] { "Food", "Inventory" };
			TITLEGROCERYLOCK = new string[2] { "Food", "Inventory" };
			TITLEUPGRADE = new string[2] { "Upgrade", "Inventory" };
			TITLESTAND = new string[2] { "Stand", "Inventory" };
			TITLECONVERT = new string[2] { "Transfer", "Inventory" };
			TITLEUPPEARL = new string[2] { "Training Stone", "Inventory" };
			TITLEBOX = new string[2] { "Inventory", "Inventory" };
			TITLESTORE = new string[4] { "Shop", "Book Store", "Fashion Store", "Clan Store" };
			TITLECLANSTORE = new string[1] { "Clan shop" };
			TITLESPLIT = new string[2] { "Split Stone", "Inventory" };
			TITLETRADE = new string[2] { "Trade", "Inventory" };
			TITLELUYENTHACH = new string[2] { "Upgrade essence", "Inventory" };
			TITLELUYENTHU = new string[2] { "Add attributes", "Inventory" };
			TITLELUYENAO = new string[2] { "Enhance equipment", "Inventory" };
			TITLEKHAMNGOC = new string[2] { "Socketing", "Inventory" };
			TITLELUYENNGOC = new string[2] { "Leveling gem", "Inventory" };
			TITLEGOTNGOC = new string[2] { "Gem Roasting", "Inventory" };
			TITLETHAONGOC = new string[2] { "Extract gem", "Inventory" };
			TITLEGIAODO = new string[2] { "Completed quest", "Inventory" };
			HELP_GOTNGOC = "I will help decrease bad options of this gem.";
			HELP_THAONGOC = "I will help you extract gem from this item.";
			HELPCRYSTAL = new string[3] { "- Use kin incase not enough coin", "- Move to inventory to choose stone", "- Amount of stones from 2 to 24" };
			HELPUPGRADE = new string[4] { "- Use coin incase not enough kin", "- Upgrading need Gold bar", "- Choose Equiptment and stone only", "Your equipment has reached max level" };
			HELPSPLIT = new string[3] { "- Move to inventory to choose Equipment", " After separation will be back to begining form", "Separation successfull" };
			HELPKHAMNGOC = new string[2] { "- Use coin incase not enough kin", "- Choose Equiptment and Gem" };
			LOCK1 = "Lock Transfer";
			...
			CLASSNEED = "Class: ";
			TASK = new string[2] { "Main quest", "Sub quest" };
			ME_TASK = "Quest";
			...
			FRIENDS = new string[2] { "Friends", "Hostile" };
			...
			MENUGAMESCR = new string[19]
			{
				"store", "Myself", "Map", "General", "Exit", "Jewellery", "Feature", "Pharmaceutical Key", "Pharmacy", "Grocery Key",
				"Grocery", "Strengthen", "Training", "Training key", "Inventory", "Split Equipment", "Area", "Trade", "Message"
			};
			SKILLTYPE = new string[5] { "Passive Support", "Active use", "Active use", "Active use", "Active use" };
			NOPOINT = new string[2] { "You are run out off skill points. Upgrade your level for more skill points.", "You are run out off potential points. Upgrade your level for more potential points. " };
			inforMe = new string[20]
			{
				"Character: ",
				"Agressive: ",
				...
				"Dodge ability: ",
				"Critical: ",
				"Close combat strike back: ",
				"Anti chakra: ",
				"Anti chakra back: ",
				"Action points: "
			};
			NUMBER = " times";
			TITLE_CT = new string[4] { "Genin", "Chunin", "Jounin", "Kage" };
			inforMePoint = new string[20]
			{
				"Action point: ", "Weapon Fame: ", "Necklace Fame: ", "Ring Fame: ", "Gems Fame: ", "Charm Fame: ", "Hat Fame: ", "Cloth Fame: ", "Gloves Fame: ", "Pants Fame: ",
				"Shoes Fame: ", "Accomplish daily quest: ", "Arrest Beast: ", "Read the basic potential book: ", "Read the basic skill book: ", "Clan: ", "Cave time left: ", "Star Fame: ", "Wind Thunder Mooncake: ", "Ice Fire Mooncake: "
			};
			ERRONUMBER = "Error occur. Please input numbers only.";
			MENUNEWCHAR = new string[3] { "Name: ", "Gender: ", "Hair: " };
			MENUGENDER = new string[2] { "Female", "Male" };
			NAMEEXIST = "This name has been taken. Please choose another one.";
			NAMEFALSE = "Character Name can only have letters and numbers";
			NAMEPOTENTIAL = new string[4] { "Strength", "Dexterity", "Constitution", "Chakra" };
			NAMEPOTENTIAL2 = new string[4] { "Strength", "Agility", "Health", "Chakra" };
			...
			{
				new string[1] { "cap" },
				new string[2] { "wea", "pon" },
				new string[1] { "cloth" },
				new string[2] { "neck", "lace" },
				new string[2] { "glo", "ves" },
				new string[1] { "ring" },
				new string[1] { "pants" },
				new string[1] { "gems" },
				new string[1] { "shoes" },
				...
				new string[1] { "mask" },
				new string[2] { "ninja", "yoroi" },
				new string[2] { "clan", "item" },
				new string[2] { "Emp", "ty" },
				new string[2] { "Ancient", "Book" },
				new string[2] { "Ar", "mor" },
				new string[2] { "Sad", "dle" },
				new string[2] { "Tas", "sels" },
				new string[2] { "Coro", "net" },
				new string[2] { "Eng", "ine" },
				new string[2] { "Sat", "nav" },
				new string[2]
				{
					"ECU",
					string.Empty
			...
			SYS = new string[4] { "Not a student", "School: Hirosaki", "School: Ookaza", "School: Haruna" };
			SYSITEM = new string[7]
			{
				string.Empty,
				"Attribute: Fire",
				"Attribute: Water",
			...
			TYPEUPPEARL = new string[2] { "Success stone train", "Training has failed" };
			TYPEUPGRADE = new string[4] { "Success,  equipped with level up ", "failed, return level of equipment", "equipment upgraded maximum", "equipment level" };
			TYPEKHAMNGOC = new string[2] { "Success socketing", "Socketing has failed" };
			MONTH = "month";
			WEEK = "week";
			DAY = "day";
			HOUR = "hour";
			...
			GENDER = new string[2] { "Gender: Female", "Gender: Male" };
			ZONE = "Area";
			POPULATION = "Population";
			PARTY = "Party";
			NOT_IN_PARTY = "At this moment, you have not joined any Party.";
			COUNT = "times";
			CLAN = new string[5] { "Info", "Member", "Warehouse", "Statistic", "Guardian" };
			CLANINFO = new string[13]
			{
				"Clan: ", "Clanmaster: ", "Member: ", "Level: ", "Experience: ", "Budget: ", "Establish: ", "Donation: ", "Maintenance fee: ", "Upgrade fee: ",
				"Enter the Territory of Clan: remain ", "Week donation: ", "Use Clan card mark: remain "
			};
			CLAN_ACTIVITY = new string[7] { "Coins at", "Establish clan, budget has", "expulsion, budget decrease", "clan contribution, budget increase", "withdraw clan budget, budget decrease", "Fee for maintain clan, budget decrease", "upgrade clan, budget decrease" };
			NOT_IN_CLAN = "You are not a member of any clan";
			CLAN_BOX = "Phát cho Thành viên";
			TELEPORT = new string[5][]
			{
				new string[1] { "Hirosaki School" },
				new string[1] { "Haruna School" },
				new string[1] { "Ookaza School" },
				new string[8] { "Village", "Kojin village", "Sanzu village", "Tone village", "Fish Village", "Chakumi Village", "Echigo Village", "Oshin Village" },
				new string[1] { "Area" }
			};
			BODY = new string[10] { "Cap", "Ring", "Cloth", "Necklace", "Gloves", "Ring", "Pants", "Gems", "Shoes", "Charm" };
			LINE = new string[2] { "Active hidden", "Active level" };
			KICKSYS = new string[4]
			{
				string.Empty,
				"Fire",
			...
			CHARINGFO = new string[3] { "Character", "Level", "Jewellery" };
			LOGINLABELS = new string[2] { "You do not have an account", "choose menu to register." };
			...
			CHAR_ORDER = new string[12]
			{
				"Trade", "Fight", "Berserker", "Add friend", "Invite to Party", "Recover", "Check info", "Private chat", "Invite to clan", "Request to join clan",
				"Block request to joint clan", "Auto recover"
			};
			ZONE_HERE = "You are in ";
			DES_TASK = new string[4] { "Let's find", " at ", " to get the quest.", "You have finished all quests this version, please wait for the next version." };
			DIES = new string[4] { "Exhausted", "Starring", "Come back", "Revive now (1 Gold bar)" };
			...
			PKS = new string[4] { "PK normal", "PK team", "PK clan", "PK Berserker" };
			ACTIONS = new string[8] { "PK status", "Friend", "Enemy", "Party", "Find party", "Clan", "Protect account", "Auto" };
			SYNTHESIS = new string[3] { "Map", "Quest", "Clan" };
			CLANS = new string[5] { "Clan Master", "Chief Elder", "Elder", "Elite", "Member" };
			CLANS_STANDFOR = new string[4] { "(CM)", "(CE)", "(ED)", "(EL)" };
			CLAN_MENU = new string[9] { "Online only", "Left", "Notice", "Contribute", "Withdraw funds", "Upgrade", "Invite to territory", "Invite to clan war", "Unlock" };
			CLAN_SORTTYPE = "Sort by dedicating week";
			TEAMLEADER_SELECT = new string[3] { "Expulsion", "Transfer", "Make friend" };
			CLANLEADER_SELECT = new string[2] { "Chief of Elders", "Elders" };
			...
			HELPPOTENTIAL1 = new string[1] { "Go to school to upgrade your marks." };
			HELPPOTENTIAL2 = new string[4] { "Strength = Attack", "Dexterity = dodge, accurate", "Strength = HP", "Chakra = MP" };
			HELPPOTENTIAL3 = new string[4] { "No need to upgrade strength", "Dexterity = dodge, accurate", "Strength = HP", "Chakra = Attack, MP" };
			HELPPOTENTIAL4 = new string[4] { "Strength = 10 attack", "Agility = 10 accurate", "Health = 10s summon time", "Chakra = 1 MP" };
			CLOSE_CURTAB = "Close current tab.";
			PUBLICCHAT = new string[2] { "Public chat", "You can chat with people around you here." };
			PARTYCHAT = new string[2] { "Same party", "You can chat with your Party member here." };
			GLOBALCHAT = new string[4] { "Global chat", "You will lose 5 Gold Bars for each use.", "This message will broadcast to everybody.", "Your account will automatically be locked if you attempt to advestise any wap website, or use profanity." };
			CLANCHAT = new string[2] { "Clan", "Yon can chat with Clanmates in this place" };
			...
			ASSIGN_KEY = new string[2] { "Assign key", "Assign to 5 key" };
			...
			MENUSTANDS = new string[12]
			{
				"Stone", "Cap", "Weapon", "Cloth", "Necklace", "Gloves", "Rings", "Cloths", "Gems", "Shoes",
				"Charms", "Miscellaneous"
			};
			...
			CLAN_ITEM = new string[5][]
			{
				new string[2] { "Requirement: Clan level 5", "Cost to Open: 1.000.000 clan coins." },
				new string[2] { "Requirement: Clan level 10.", "Cost to Open: 5.000.000 clan coins." },
				new string[2] { "Requirement: Clan level 15.", "Cost to Open: 10.000.000 clan coins." },
				new string[2] { "Requirement: Clan level 20.", "Cost to Open: 20.000.000 clan coins." },
				new string[2] { "Requirement: Clan level 25.", "Cost to Open: 30.000.000 clan coins." }
			};
			AUTO_TEXT = new string[8] { "HP: ", "MP: ", "Using food level: ", "Always using skill to support", "Pick up Kins", "Pick up Kins and Hp, MP", "Pick up Kins, Hp, Mp and Material", "Not picked up" };
			...
			ALEVEL = new string[8] { "Level 1", "Level 10", "Level 20", "Level 30", "Level 40", "Level 50", "Level 60", "Level 70" };
			ASKILL = "Not time yet to use skill";
			AOPENACC = "Account required password, input password to unlock.";
			VITALITY = "Vitality";
			MON_NAME = "Name of mounts";
			LUYEN_THACH = new string[3] { "Upgrade essence by using 9 essences", "of the same kind or 3 common essences", "and stone level 11 or 3 rare essences and stone level 12." };
			...
			POWER = "Fuel";
			CHO_KEO = "Give candy";
			TUTINH = new string[4] { "essence", "essence", "common essences", "rare essences" };
